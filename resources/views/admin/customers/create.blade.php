...
<div class="container mx-auto my-8">
    <h1 class="text-3xl font-bold mb-4 text-gray-100">Tambah Customer Baru</h1>

    <!-- Form to create a new customer -->
    <form action="{{ route('admin.customers.store') }}" method="POST" class="w-full max-w-lg bg-gray-800 p-6 rounded-lg">
        @csrf
